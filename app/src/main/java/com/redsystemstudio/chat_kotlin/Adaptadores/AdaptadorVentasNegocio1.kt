...
class AdaptadorVentasNegocio1(
    private var ventas: List<VentaNegocio1>,
    private val onVerDetalleClick: (VentaNegocio1) -> Unit
) : RecyclerView.Adapter<AdaptadorVentasNegocio1.VentaViewHolder>() {
    ...
    fun actualizarVentas(nuevasVentas: List<VentaNegocio1>) {
        ventas = nuevasVentas
        filtrarVentas("")
    }
